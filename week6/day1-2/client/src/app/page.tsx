...
export default function Home() {
  const { products: newArrivals, isLoading: isLoadingArrivals } = useProducts({ limit: 4 });
  const { products: topSelling, isLoading: isLoadingSelling } = useProducts({ limit: 4, sort: 'rating:desc' });
