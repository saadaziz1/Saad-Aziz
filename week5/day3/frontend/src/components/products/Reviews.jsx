        ...
        <form onSubmit={handleSubmitReview}>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <Input
              ...
              placeholder={isAuthenticated() ? "Write your review..." : "Write your review... (Login required)"}
              className="flex-1 w-full lg:min-w-96"
            />
            <Button 
              type="submit" 
            ...
            >
              ...
              <span className="sm:hidden">Send Review</span>
            </Button>
          </div>
        </form>
      </Card>
