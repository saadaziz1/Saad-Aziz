...
export function SearchFilters({ onSearch }: SearchFiltersProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl  flex flex-col items-center  md:flex-row justify-center md:justify-between gap-4">
      ...
      <div className="w-5/12 ">
        <Button onClick={handleSearch} className="w-full bg-[#4A5FBF] hover:bg-[#3A4FAF]">
