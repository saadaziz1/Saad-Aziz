      ...
      <div className="absolute left-[calc(12.5%+1px)] w-full">
        <div className="flex items-center justify-between mb-6 pr-[calc(12.5%)]">
          <div className="flex items-center gap-1">
            <h2 className="text-[#f5f5f5] text-[18px] font-['Poppins']">Game on sale</h2>
            <ChevronRight className="w-[9px] h-[9px] text-[#f5f5f5] rotate-[-90deg]" />
          </div>
          <div className="flex gap-2">
            <button className="game-sale-prev w-[30px] h-[30px] rounded-full border-2 border-[#f5f5f5] border-opacity-50 flex items-center justify-center hover:border-opacity-100 transition-opacity">
              <ChevronLeft className="w-4 h-4 text-[#f5f5f5]" />
            </button>
            <button className="game-sale-next w-[30px] h-[30px] rounded-full border-2 border-[#f5f5f5] flex items-center justify-center hover:border-opacity-80 transition-opacity">
        ...
        <Swiper
          modules={[Navigation]}
          navigation={{
            prevEl: '.game-sale-prev',
            nextEl: '.game-sale-next',
          }}
          spaceBetween={20}
          slidesPerView={5}
          breakpoints={{
