  ...
  return (
    <div
      className={cn(
        ...
        "laptop:flex-col relative mx-auto flex w-full max-w-job rounded-lg bg-white dark:bg-gray-800 px-10 py-8 transition-colors shadow-lg"
      )}
    >
      <img
      ...
      <div className="laptop:space-y-2 laptop:my-2 flex flex-col justify-between">
        ...
        <Link href={`/jobs/${jobInfo.id}`}>
          <h2 className="cursor-pointer text-xl font-medium text-gray-900 dark:text-white transition-colors hover:text-cyan-800">
            {jobInfo.position}
          </h2>
        </Link>
