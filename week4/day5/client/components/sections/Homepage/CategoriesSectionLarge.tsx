...
export function CategoriesSectionLarge({title,description,categoriesData,sectionType}:{title:string, description?:string, categoriesData: any[], sectionType?: 'movies' | 'shows'}) {
      ...
      <div className="max-w-350 3xl:max-w-400 mx-auto overflow-hidden">
        <div className="flex items-center justify-between mb-12">
          <div>
           ...
           { description && <p className="text-gray-400 text-sm 3xl:text-lg mt-2">
              {description}
            </p>}
          </div>
