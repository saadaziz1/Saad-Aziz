...
const SuperAdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/superadmin/admins', icon: '🛡️', label: 'Admin Management' },
    { path: '/superadmin/videos', icon: '🎬', label: 'Video Management' },
    { path: '/superadmin/tmdb-movies', icon: '🎭', label: 'TMDb Movies' },
    { path: '/superadmin/added-movies', icon: '📽️', label: 'Added Movies' },
    { path: '/superadmin/plans', icon: '💳', label: 'Subscription Plans' },
  ];
    ...
    <div className="admin-layout">
      <div className={`admin-sidebar ${sidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          ...
          <div className="admin-badge" style={{ background: 'linear-gradient(135deg, #9333ea, #c026d3)' }}>
            Super Admin Panel
          </div>
        </div>
        ...
        <div className="sidebar-footer">
          <div className="user-info">
            <div className="user-avatar" style={{ background: 'linear-gradient(135deg, #9333ea, #c026d3)' }}>
