...
const heroImg = '/imgs/hero img.jpeg';
const ld1 = '/imgs/ld1.jpeg';
const ld2 = '/imgs/ld2.jpeg';
const ld3 = '/imgs/ld3.jpeg';
const ld4 = '/imgs/ld4.jpeg';
const ld5 = '/imgs/ld5.jpeg';
const ld6 = '/imgs/ld6.jpeg';
const ld7 = '/imgs/ld7.jpeg';
const ld8 = '/imgs/ld8.jpeg';
const ld9 = '/imgs/ld9.jpeg';
...
export const LandingPage = () => {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Hero Section */}
      <section className="flex-1 flex items-center mb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img 
                src={heroImg} 
                alt="Tea spoons with different tea varieties"
            ...
            <div className="space-y-4 max-w-md">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900" style={{ fontFamily: 'Prosto One, cursive' }}>
                Every day is unique,<br />
                just like our tea
              </h1>
              <div className="space-y-3 text-gray-600">
                <p>
                  Lorem ipsum dolor sit amet consectetur. Orci nibh nullam risus adipiscing odio. Neque lacus nibh arcu ut.
                </p>
                <p>
                  Lorem ipsum dolor sit amet consectetur. Orci nibh nullam risus adipiscing odio. Neque lacus nibh arcu ut.
                </p>
              ...
              <button 
                className="px-16 py-4 text-white text-xs font-medium uppercase tracking-wider hover:opacity-90 transition-opacity"
                style={{ backgroundColor: '#282828', fontFamily: 'Montserrat, sans-serif', fontWeight: '500' }}
              >
                BROWSE TEAS
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="font-medium text-gray-900 uppercase text-sm">450+ KIND OF LOOSELEAF TEA</h3>
            </div>
            <div className="flex items-center space-x-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="font-medium text-gray-900 uppercase text-sm">CERTIFICATED ORGANIC TEAS</h3>
            </div>
            <div className="flex items-center space-x-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="font-medium text-gray-900 uppercase text-sm">FREE DELIVERY</h3>
            </div>
            <div className="flex items-center space-x-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="font-medium text-gray-900 uppercase text-sm">SAMPLE FOR ALL TEAS</h3>
            </div>
          </div>
          
          <div className="text-center mt-12">
            <button 
              className="px-20 py-4 border text-xs font-medium uppercase tracking-wider bg-transparent transition-all duration-300 ease-in-out"
              style={{ 
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12" style={{ fontFamily: 'Prosto One, cursive' }}>
            Our Collections
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center space-y-4">
              <img src={ld1} alt="Black Tea" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>BLACK TEA</h3>
            </div>
            <div className="text-center space-y-4">
              <img src={ld2} alt="Green Tea" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>GREEN TEA</h3>
            </div>
            <div className="text-center space-y-4">
              <img src={ld3} alt="White Tea" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>WHITE TEA</h3>
            </div>
            
            {/* Row 2 */}
            <div className="text-center space-y-4">
              <img src={ld4} alt="Matcha" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>MATCHA</h3>
            </div>
            <div className="text-center space-y-4">
              <img src={ld5} alt="Herbal Tea" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>HERBAL TEA</h3>
            </div>
            <div className="text-center space-y-4">
              <img src={ld6} alt="Chai" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>CHAI</h3>
            </div>
            
            {/* Row 3 */}
            <div className="text-center space-y-4">
              <img src={ld7} alt="Oolong" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>OOLONG</h3>
            </div>
            <div className="text-center space-y-4">
              <img src={ld8} alt="Rooibos" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>ROOIBOS</h3>
            </div>
            <div className="text-center space-y-4">
              <img src={ld9} alt="Teaware" className="w-full aspect-square object-cover border" style={{ borderColor: '#F4F4F4' }} />
              <h3 className="font-medium text-gray-900 uppercase" style={{ fontWeight: '500' }}>TEAWARE</h3>
            </div>
          </div>
        </div>
      </section>
