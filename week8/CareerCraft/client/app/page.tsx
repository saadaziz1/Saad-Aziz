  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-indigo-100 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6">
        ...
        >
          Build Your Future with <span className="text-indigo-600">CareerCraft</span>
        </motion.h2>
        ...
        >
          <Link
            ...
            className="px-6 py-3 rounded-lg bg-indigo-600 text-white font-semibold shadow-lg hover:bg-indigo-700 transition"
          >
            Get Started
          </Link>
        </motion.div>
